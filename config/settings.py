"""
Django settings for vehicules-occasion project.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='vehicules_db'),
...
DEFAULT_VAT_RATE = config('DEFAULT_VAT_RATE', default=20.0, cast=float)
